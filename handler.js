...
global.dfail = (type, m, conn) => {
  let msg = {
    ...
    owner: '_Lu Siapa?_',
    mods: '_Lu Siapa?_',
    premium: 'Khusus Premium, Daftar Dulu Ke Owner, ketik #sewa',
    group: 'Di grup ini bisanya',
    private: 'PC gua aja',
    admin: '_Lah lu member mau ngapain anjir_',
    botAdmin: 'Bot bukan admin, mana bisa gitu',
