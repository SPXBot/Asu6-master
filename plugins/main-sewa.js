...
5. Di larang spam dalam penggunaan
    ...
    const button = {
        ...
        {title: 'Trial', description: "GRATIS\nBot Gratis Selama 12 Jam.", rowId:".joingratis"},
        {title: '1 Bulan', description: "Rp10.000\nSewa bot selama 1 bulan.", rowId:".konfir Saya ingin mendaftarkan 1 bulan"},
        {title: 'Owner? ', description: "Nomor Owner.", rowId:".owner"},
        {title: 'Rules', description: "Baca Rules/Peraturan?", rowId:".rules"},
        {title: 'Join?', description: "Cara Memasukkan Bot Ke Grup.", rowId:".joingratis"},
       ] }],
        listType: 1
       }
