...
handler.help = ['ngentod','pacaran','babi','anjing','cantik','ganteng','cakep','banci','tolol','setan','tua', 'kontol']
handler.tags = ['fun', 'update']
handler.command = /^(ngentod|pacaran|babi|anjing|cantik|ganteng|cakep|banci|tolol|setan|tua|kontol)$/i
handler.owner = false
handler.limit = true
handler.fail = null
